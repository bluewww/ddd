...
MMDesc simple_edit_menu[] =
{
    ...
    GENTRYL("paste", N_("paste"), MMPush,
	    ...
	    0, 0),
    GENTRYL("clearAll", N_("clearAll"), MMPush,
	    BIND(ClearAllCB, 0),
    ...
    GENTRYL("delete", N_("delete"), MMPush,
	    ...
	    0, 0),
    MMSep,
    GENTRYL("selectAll", N_("selectAll"), MMPush,
	    BIND(SelectAllCB, 0),
...
{
#if defined(IF_XM)
    GENTRYL("onHelp", N_("onHelp"), MMPush,
	    BIND(HelpOnHelpCB, 0),
	    sigc::ptr_fun(HelpOnHelpCB),
	    0, 0),
    MMSep,
    GENTRYL("onItem", N_("onItem"), MMPush,
	    BIND(HelpOnItemCB, 0),
	    sigc::ptr_fun(HelpOnItemCB),
	    0, 0),
    GENTRYL("onWindow", N_("onWindow"), MMPush,
	    BIND(HelpOnWindowCB, 0),
	    sigc::ptr_fun(HelpOnWindowCB),
	    0, 0),
    MMSep,
    GENTRYL("whatNext", N_("whatNext"), MMPush,
	    BIND(WhatNextCB, 0),
	    sigc::ptr_fun(WhatNextCB),
	    0, 0),
    GENTRYL("tipOfTheDay", N_("tipOfTheDay"), MMPush,
	    BIND(TipOfTheDayCB, 0),
	    sigc::ptr_fun(TipOfTheDayCB),
	    0, 0),
    MMSep,
    GENTRYL("dddManual", N_("dddManual"), MMPush,
	    BIND(DDDManualCB, 0),
	    sigc::ptr_fun(DDDManualCB),
	    0, 0),
    GENTRYL("news", N_("news"), MMPush,
	    BIND(DDDNewsCB, 0),
	    sigc::ptr_fun(DDDNewsCB),
	    0, 0),
    GENTRYL("gdbManual", N_("gdbManual"), MMPush,
	    BIND(GDBManualCB, 0),
	    sigc::ptr_fun(GDBManualCB),
	    0, 0),
    MMSep,
    GENTRYL("license", N_("license"), MMPush,
	    BIND(DDDLicenseCB, 0),
	    sigc::ptr_fun(DDDLicenseCB),
	    0, 0),
    GENTRYL("www", N_("www"), MMPush,
	    BIND(DDDWWWPageCB, 0),
	    sigc::ptr_fun(DDDWWWPageCB),
	    0, 0),
    MMSep,
    GENTRYL("onVersion", N_("onVersion"), MMPush,
