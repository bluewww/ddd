...
{
    GENTRYL("command", N_("command"), MMPush,
	    BIND(PlotCommandCB, 0),
	    sigc::bind(sigc::ptr_fun(PlotCommandCB), NULL),
	    0, 0),
    MMSep,
    GENTRYL("replot", N_("replot"),   MMPush,
	    BIND(ReplotCB, 0),
    ...
    GENTRYL("print", N_("print"),     MMPush,
	    ...
	    0, 0),
    GENTRYL("export", N_("export"),   MMPush,
	    BIND(ExportPlotCB, 0),
...
{
    GENTRYL("border", N_("border"),       MMToggle,
	    BIND(ToggleOptionCB, 0),
	    sigc::bind(sigc::ptr_fun(ToggleOptionCB), NULL),
	    0, 0),
    GENTRYL("time", N_("time"),           MMToggle,
	    BIND(ToggleOptionCB, 0),
	    sigc::bind(sigc::ptr_fun(ToggleOptionCB), NULL),
	    0, 0),
    MMSep,
    GENTRYL("grid", N_("grid"),           MMToggle,
	    BIND(ToggleOptionCB, 0),
	    sigc::bind(sigc::ptr_fun(ToggleOptionCB), NULL),
	    0, 0),
    GENTRYL("xzeroaxis", N_("xzeroaxis"), MMToggle,
	    BIND(ToggleOptionCB, 0),
	    sigc::bind(sigc::ptr_fun(ToggleOptionCB), NULL),
	    0, 0),
    GENTRYL("yzeroaxis", N_("yzeroaxis"), MMToggle,
	    BIND(ToggleOptionCB, 0),
	    sigc::bind(sigc::ptr_fun(ToggleOptionCB), NULL),
	    0, 0),
    MMEnd
...
{
    GENTRYL("base", N_("base"),           MMToggle,
	    BIND(SetContourCB, 0),
	    sigc::bind(sigc::ptr_fun(SetContourCB), NULL),
	    0, 0),
    GENTRYL("surface", N_("surface"),     MMToggle,
	    BIND(SetContourCB, 0),
	    sigc::bind(sigc::ptr_fun(SetContourCB), NULL),
	    0, 0),
    MMEnd
...
{
    GENTRYL("logscale", N_("logscale"),   MMToggle,
	    BIND(ToggleLogscaleCB, 0),
	    sigc::bind(sigc::ptr_fun(ToggleLogscaleCB), NULL),
	    0, 0),
    MMSep,
    GENTRYL("xtics", N_("xtics"),         MMToggle,
	    BIND(ToggleOptionCB, 0),
	    sigc::bind(sigc::ptr_fun(ToggleOptionCB), NULL),
	    0, 0),
    GENTRYL("ytics", N_("ytics"),         MMToggle,
	    BIND(ToggleOptionCB, 0),
	    sigc::bind(sigc::ptr_fun(ToggleOptionCB), NULL),
	    0, 0),
    GENTRYL("ztics", N_("ztics"),         MMToggle,
	    BIND(ToggleOptionCB, 0),
	    sigc::bind(sigc::ptr_fun(ToggleOptionCB), NULL),
	    0, 0),
    MMEnd
...
{
    GENTRYL("points", N_("points"),              MMToggle,
	    BIND(SetStyleCB, 0),
	    sigc::bind(sigc::ptr_fun(SetStyleCB), NULL),
	    0, 0),
    GENTRYL("lines", N_("lines"),                MMToggle,
	    BIND(SetStyleCB, 0),
	    sigc::bind(sigc::ptr_fun(SetStyleCB), NULL),
	    0, 0),
    GENTRYL("lines3d", N_("lines3d"),            MMToggle,
	    BIND(SetStyleCB, 0),
	    sigc::bind(sigc::ptr_fun(SetStyleCB), NULL),
	    0, 0),
    GENTRYL("linespoints", N_("linespoints"),    MMToggle,
	    BIND(SetStyleCB, 0),
	    sigc::bind(sigc::ptr_fun(SetStyleCB), NULL),
	    0, 0),
    GENTRYL("linespoints3d", N_("linespoints3d"),  MMToggle | MMUnmanaged, 
	    BIND(SetStyleCB, 0),
	    sigc::bind(sigc::ptr_fun(SetStyleCB), NULL),
	    0, 0),
    GENTRYL("impulses", N_("impulses"),          MMToggle,
	    BIND(SetStyleCB, 0),
	    sigc::bind(sigc::ptr_fun(SetStyleCB), NULL),
	    0, 0),
    GENTRYL("dots", N_("dots"),                  MMToggle,
	    BIND(SetStyleCB, 0),
	    sigc::bind(sigc::ptr_fun(SetStyleCB), NULL),
	    0, 0),
    GENTRYL("steps2d", N_("steps2d"),            MMToggle,
	    BIND(SetStyleCB, 0),
	    sigc::bind(sigc::ptr_fun(SetStyleCB), NULL),
	    0, 0),
    GENTRYL("boxes2d", N_("boxes2d"),            MMToggle,
	    BIND(SetStyleCB, 0),
	    sigc::bind(sigc::ptr_fun(SetStyleCB), NULL),
	    0, 0),
    MMEnd
...
{
    GENTRYL("file", N_("file"),         MMMenu,          MMNoCB, MDUMMY, file_menu,        0),
    GENTRYL("edit", N_("edit"),         MMMenu,          MMNoCB, MDUMMY, simple_edit_menu, 0),
    GENTRYL("plotView", N_("plotView"), MMMenu,          MMNoCB, MDUMMY, view_menu,        0),
    GENTRYL("plot", N_("plot"),         MMRadioMenu,     MMNoCB, MDUMMY, plot_menu,        0),
    GENTRYL("scale", N_("scale"),       MMMenu,          MMNoCB, MDUMMY, scale_menu,       0),
    GENTRYL("contour", N_("contour"),   MMMenu,          MMNoCB, MDUMMY, contour_menu,     0),
    GENTRYL("help", N_("help"),         MMMenu | MMHelp, MMNoCB, MDUMMY, simple_help_menu, 0),
    MMEnd
};
