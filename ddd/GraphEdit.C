...
static char defaultTranslations[] =
    ...
    "~Meta<Key>KP_4:    select-prev()\n"
    "~Meta<Key>KP_6:    select-next()\n"
    "~Meta<Key>KP_7:    select-first()\n"
    "~Meta<Key>KP_0:    select-first()\n"
    "~Meta<Key>B:       select-prev()\n"
    "~Meta<Key>F:       select-next()\n"
    "~Meta<Key>P:       select-prev()\n"
    "~Meta<Key>N:       select-next()\n"
    "~Meta<Key>A:       select-first()\n"
