...
ITEM If a core file was generated, please select LBL(Help, Debug DDD),\n\
    and type KBD(where) at the SAMP((gdb)) prompt. Include the KBD(where) \
output.\n\
...
Click on LBL(Debug) to invoke a debugger on DDD.\n\
Click on LBL(Exit) to exit DDD.\n\
