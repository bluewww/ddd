...
c ~s<Key>A:		gdb-beginning-of-line()	    \n\
c<Key>B:		gdb-backward-character()    \n\
c<Key>C:		gdb-control(^C)		    \n\
c<Key>D:		gdb-delete-or-control(^D)   \n\
c ~s<Key>E:		gdb-end-of-line()	    \n\
c<Key>F:		gdb-forward-character()	    \n\
c<Key>G:		gdb-control(^C)		    \n\
c<Key>H:		delete-previous-character() \n\
c<Key>K:		delete-to-end-of-line()	    \n\
c<Key>N:		gdb-next-history()	    \n\
c<Key>P:		gdb-previous-history()	    \n\
c<Key>U: 		gdb-set-line("")	    \n\
c<Key>V:		next-page()		    \n\
m<Key>V:		previous-page()		    \n\
c<Key>W:		delete-previous-word()	    \n\
c<Key>osfBackSpace:	delete-previous-word()	    \n\
c<Key>Y:		unkill()		    \n\
c<Key>backslash:	gdb-control(^\\)	    \n\
c<Key>R:		gdb-isearch-prev()          \n\
c<Key>S:		gdb-isearch-next()          \n\
c<Key>T:		gdb-complete-command()	    \n\
...
~s<Key>osfPageUp:	previous-page()		    \n\
~s<Key>osfPageDown:	next-page()	            \n\
~s<Key>Prior:		previous-page()		    \n\
~s<Key>Next:		next-page()	            \n\
s<Key>osfPageUp:	previous-page(extend)	    \n\
s<Key>osfPageDown:	next-page(extend)           \n\
s<Key>Prior:		previous-page(extend)	    \n\
s<Key>Next:		next-page(extend)	    \n\
...
~c ~s<Btn1Down>:	source-start-select-word()  \n\
~c ~s<Btn1Up>:		source-end-select-word()    \n\
c ~s<Key>A:		beginning-of-line()	    \n\
c<Key>B:		backward-character()	    \n\
c ~s<Key>E:		end-of-line()		    \n\
c<Key>F:		forward-character()	    \n\
...
s<Key>Next:		next-page(extend)	    \
			source-update-glyphs()	    \n\
~s<Key>Home:		beginning-of-line()	    \n\
~s<Key>End:		end-of-line()		    \n])dnl
...
~m<Key>osfBackSpace:	     gdb-process()\n\
~m<Key>osfCancel:	     gdb-process()\n\
~c ~m<Key>BackSpace:	     gdb-process()\n\
~m<Key>Tab:		     gdb-process()\n\
~c ~m<Key>Return:	     gdb-process()\n\
~c ~m<Key>Escape:	     gdb-process()\n\
~m<Key>Delete:		     gdb-process()\n\
~c ~m<Key>space:	     gdb-process()\n\
~c ~m<Key>exclam:	     gdb-process()\n\
~c ~m<Key>quotedbl:	     gdb-process()\n\
~c ~m<Key>numbersign:	     gdb-process()\n\
~c ~m<Key>dollar:	     gdb-process()\n\
~c ~m<Key>percent:	     gdb-process()\n\
~c ~m<Key>ampersand:	     gdb-process()\n\
~c ~m<Key>apostrophe:	     gdb-process()\n\
~c ~m<Key>parenleft:	     gdb-process()\n\
~c ~m<Key>parenright:	     gdb-process()\n\
~c ~m<Key>asterisk:	     gdb-process()\n\
~c ~m<Key>plus:		     gdb-process()\n\
~c ~m<Key>comma:	     gdb-process()\n\
~c ~m<Key>minus:	     gdb-process()\n\
~c ~m<Key>period:	     gdb-process()\n\
~c ~m<Key>slash:	     gdb-process()\n\
~c ~m<Key>0:		     gdb-process()\n\
~c ~m<Key>1:		     gdb-process()\n\
~c ~m<Key>2:		     gdb-process()\n\
~c ~m<Key>3:		     gdb-process()\n\
~c ~m<Key>4:		     gdb-process()\n\
~c ~m<Key>5:		     gdb-process()\n\
~c ~m<Key>6:		     gdb-process()\n\
~c ~m<Key>7:		     gdb-process()\n\
~c ~m<Key>8:		     gdb-process()\n\
~c ~m<Key>9:		     gdb-process()\n\
~c ~m<Key>colon:	     gdb-process()\n\
~c ~m<Key>semicolon:	     gdb-process()\n\
~c ~m<Key>less:		     gdb-process()\n\
~c ~m<Key>equal:	     gdb-process()\n\
~c ~m<Key>greater:	     gdb-process()\n\
~c ~m<Key>question:	     gdb-process()\n\
~c ~m<Key>at:		     gdb-process()\n\
~c ~m<Key>A:		     gdb-process()\n\
~c ~m<Key>B:		     gdb-process()\n\
~c ~m<Key>C:		     gdb-process()\n\
~c ~m<Key>D:		     gdb-process()\n\
~c ~m<Key>E:		     gdb-process()\n\
~c ~m<Key>F:		     gdb-process()\n\
~c ~m<Key>G:		     gdb-process()\n\
~c ~m<Key>H:		     gdb-process()\n\
~c ~m<Key>I:		     gdb-process()\n\
~c ~m<Key>J:		     gdb-process()\n\
~c ~m<Key>K:		     gdb-process()\n\
~c ~m<Key>L:		     gdb-process()\n\
~c ~m<Key>M:		     gdb-process()\n\
~c ~m<Key>N:		     gdb-process()\n\
~c ~m<Key>O:		     gdb-process()\n\
~c ~m<Key>P:		     gdb-process()\n\
~c ~m<Key>Q:		     gdb-process()\n\
~c ~m<Key>R:		     gdb-process()\n\
~c ~m<Key>S:		     gdb-process()\n\
~c ~m<Key>T:		     gdb-process()\n\
~c ~m<Key>U:		     gdb-process()\n\
~c ~m<Key>V:		     gdb-process()\n\
~c ~m<Key>W:		     gdb-process()\n\
~c ~m<Key>X:		     gdb-process()\n\
~c ~m<Key>Y:		     gdb-process()\n\
~c ~m<Key>Z:		     gdb-process()\n\
~c ~m<Key>bracketleft:	     gdb-process()\n\
~c ~m<Key>backslash:	     gdb-process()\n\
~c ~m<Key>bracketright:	     gdb-process()\n\
~c ~m<Key>asciicircum:	     gdb-process()\n\
~c ~m<Key>underscore:	     gdb-process()\n\
~c ~m<Key>grave:	     gdb-process()\n\
~c ~m<Key>a:		     gdb-process()\n\
~c ~m<Key>b:		     gdb-process()\n\
~c ~m<Key>c:		     gdb-process()\n\
~c ~m<Key>d:		     gdb-process()\n\
...
~c ~m<Key>y:		     gdb-process()\n\
~c ~m<Key>z:		     gdb-process()\n\
~c ~m<Key>braceleft:	     gdb-process()\n\
~c ~m<Key>bar:		     gdb-process()\n\
~c ~m<Key>braceright:	     gdb-process()\n\
~c ~m<Key>asciitilde:	     gdb-process()\n\
~c ~m<Key>KP_0:		     gdb-process()\n\
~c ~m<Key>KP_1:		     gdb-process()\n\
~c ~m<Key>KP_2:		     gdb-process()\n\
~c ~m<Key>KP_3:		     gdb-process()\n\
~c ~m<Key>KP_4:		     gdb-process()\n\
~c ~m<Key>KP_5:		     gdb-process()\n\
~c ~m<Key>KP_6:		     gdb-process()\n\
~c ~m<Key>KP_7:		     gdb-process()\n\
~c ~m<Key>KP_8:		     gdb-process()\n\
~c ~m<Key>KP_9:		     gdb-process()\n\
~c ~m<Key>KP_Space:	     gdb-process()\n\
~c ~m<Key>KP_Tab:	     gdb-process()\n\
~c ~m<Key>KP_Enter:	     gdb-process()\n\
~c ~m<Key>KP_Equal:	     gdb-process()\n\
~c ~m<Key>KP_Multiply:	     gdb-process()\n\
~c ~m<Key>KP_Add:	     gdb-process()\n\
~c ~m<Key>KP_Separator:	     gdb-process()\n\
~c ~m<Key>KP_Subtract:	     gdb-process()\n\
~c ~m<Key>KP_Decimal:	     gdb-process()\n\
~c ~m<Key>KP_Divide:	     gdb-process()\n\
c ~m<Key>C:		     gdb-process()\n\
c ~m<Key>D:		     gdb-process()\n\
c ~m<Key>U:		     gdb-process()])dnl
...
Ddd*source_form_w.XmPushButton.translations: \
GLYPH_TRANSLATIONS dnl GDB_TRANSLATIONS

Ddd*code_form_w.XmPushButton.translations:   \
GLYPH_TRANSLATIONS dnl GDB_TRANSLATIONS


! This defines the popup menus in the graph window.
define(GRAPH_TRANSLATIONS,[#override\n\
~s<Btn1Down>:	graph-select-or-move()\n\
s<Btn1Down>:	graph-toggle-or-move()\n\
<Btn2Down>:	graph-toggle-or-move()\n\
<Btn3Down>:	graph-select() graph-popup-menu()\n])dnl
Ddd*graph_edit.translations: \
...
dnl Instead, define translations for all labels and several buttons
dnl define(BUTTON_TRANSLATIONS,[#override\n\
dnl ~c<Btn1Down>:	Arm()\n\
dnl ~c<Btn1Up>:        Activate() Disarm()\n])dnl
...
Ddd*menubar*fileMenu.open_file.accelerator:      ~s m<Key>O
...
Ddd*menubar*fileMenu.open_session.accelerator:          ~s m<Key>O
...
Ddd*menubar*fileMenu.attach.accelerator:      ~s c<Key>Z
...
Ddd*menubar*fileMenu.detach.accelerator:       s c<Key>Z
...
! Ddd*menubar*fileMenu.print.accelerator:       ~s m<Key>P
...
! Ddd*menubar*fileMenu.printAgain.accelerator:      s m<Key>P
...
Ddd*menubar*fileMenu.make.accelerator:      ~s c<Key>M
...
Ddd*menubar*fileMenu.makeAgain.accelerator:      s c<Key>M
...
! Ddd*menubar*fileMenu.close.accelerator:      m<Key>W
...
Ddd*menubar*fileMenu.restart.accelerator:      s c<Key>Q
...
Ddd*menubar*fileMenu.exit.accelerator:	    ~s c<Key>Q
...
Ddd*editMenu.cut.accelerator:				s<Key>Delete
...
Ddd*editMenu.copy.accelerator:				c<Key>Insert
...
Ddd*editMenu.paste.accelerator:				s<Key>Insert
...
Ddd*menubar*programMenu.run.accelerator:	   c ~s<Key>X
...
Ddd*menubar*programMenu.run_again.accelerator:	   c s<Key>X
...
Ddd*menubar*programMenu*separateExecWindow.accelerator:	m<Key>X
...
Ddd*menubar*programMenu.step.accelerator:	   c ~s<Key>I
...
Ddd*menubar*programMenu.stepi.accelerator:	   c s<Key>I
...
Ddd*menubar*programMenu.next.accelerator:	   c ~s<Key>J
...
Ddd*menubar*programMenu.nexti.accelerator:	   c s<Key>J
...
Ddd*menubar*programMenu.cont.accelerator:	   c<Key>O
...
Ddd*menubar*programMenu.finish.accelerator:	   c<Key>Return
...
Ddd*menubar*programMenu.kill.accelerator:	   c s<Key>K
...
Ddd*menubar*programMenu.break.accelerator:	   c<Key>C
...
Ddd*menubar*programMenu.quit.accelerator:	   c<Key>\\ 
...
! *commandsMenu.prev.accelerator:	        c<Key>P
...
! *commandsMenu.next.accelerator:	        c<Key>N
...
! *commandsMenu.complete.accelerator:	        c<Key>I
...
Ddd*commandsMenu.isearch_prev.accelerator:	c<Key>R
...
Ddd*commandsMenu.isearch_next.accelerator:	c<Key>S
...
! *commandsMenu.clear_line.accelerator:	        c ~s ~m<Key>U
...
Ddd*commandsMenu.clear_window.accelerator:      c s ~m<Key>U
...
Ddd*stackMenu.up.accelerator:		c<Key>Up
...
Ddd*stackMenu.down.accelerator:		c<Key>Down
...
Ddd*sourceMenu*findWordsOnly.accelerator:	m<Key>W
...
Ddd*sourceMenu*disassemble.accelerator:		m<Key>M
...
Ddd*sourceMenu.edit.accelerator:	c s ~m<Key>E
...
Ddd*sourceMenu.reload.accelerator:	c s ~m<Key>L
...
Ddd*sourceMenu.back.accelerator:	c<Key>Left
...
Ddd*sourceMenu.forward.accelerator:	c<Key>Right
...
Ddd*dataMenu.detectAliases.accelerator:	m<Key>A
...
Ddd*dataMenu.info locals.accelerator:	m<Key>L
...
Ddd*dataMenu.info args.accelerator:	m<Key>U
...
Ddd*dataMenu.dump.accelerator:		m<Key>L
...
Ddd*dataMenu.l.accelerator:		m<Key>L
...
Ddd*dataMenu.align.accelerator:		m<Key>G
...
Ddd*dataMenu.rotate.accelerator:	m<Key>R
...
Ddd*dataMenu.layout.accelerator:	m<Key>Y
...
Ddd*dataMenu.selectAll.accelerator:	m<Key>Z
...
Ddd*dataMenu.refresh.accelerator:	c ~s ~m<Key>L
...
Ddd*helpMenu.whatNext.accelerator:		s ~c<Key>F1
...
Ddd*helpMenu.onContext.accelerator:		~s ~c<Key>F1
...
Ddd*helpMenu.onVersion.accelerator:		~s c<Key>F1
