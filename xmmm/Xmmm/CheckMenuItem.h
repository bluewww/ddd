...
namespace Xmmm {
    ...
    public:
	CheckMenuItem(Xmmm::Container &parent, const Xmmm::String &name="",
		      const Xmmm::String &label="");
	CheckMenuItem(::Widget parent, const Xmmm::String &name="",
