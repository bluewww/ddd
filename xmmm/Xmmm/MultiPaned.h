...
#ifndef XMMM_MULTIPANED_H
#define XMMM_MULTIPANED_H

#include <Xmmm/Container.h>

namespace Xmmm {

    class MultiPaned: public Container {
	::Widget rc_;
    public:
	MultiPaned(Xmmm::Widget &parent, const Xmmm::String &name="");
	~MultiPaned(void);
