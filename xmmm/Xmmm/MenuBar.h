...
#ifndef XMMM_MENUBAR_H
#define XMMM_MENUBAR_H
...
namespace Xmmm {
    ...
    public:
	MenuBar(Xmmm::Container &parent, const Xmmm::String &name="");
	MenuBar(::Widget parent, const Xmmm::String &name=""); // TEMPORARY
	~MenuBar(void);
