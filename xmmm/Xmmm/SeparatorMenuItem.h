...
#ifndef XMMM_SEPARATORMENUITEM_H
#define XMMM_SEPARATORMENUITEM_H
...
namespace Xmmm {
    ...
    private:
	::Widget separatormenuitem_;
	void init_signals(void);
    protected:
	sigc::signal<void> signal_clicked_;
	static void activate_callback(::Widget widget, XtPointer data);
    public:
	SeparatorMenuItem(Xmmm::Container &parent, const Xmmm::String &name="");
	SeparatorMenuItem(::Widget parent, const Xmmm::String &name=""); // TEMPORARY
...
#endif // XMMM_SEPARATORMENUITEM_H
